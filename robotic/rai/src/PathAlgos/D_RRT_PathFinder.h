...
struct D_PathFinder : NonCopyable {
  ...
  void setProblem(const rai::Configuration& C, const arr& starts, const arr& goals, const std::map<int, arr>& frames, double collisionTolerance=-1., bool isIndependent=false);
